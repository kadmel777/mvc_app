class CopiesController < ApplicationController
  ...
  # POST /copies.json
  def create
    @copy = Copie.new(copy_params)

    respond_to do |format|
      if @copy.save
        format.html { redirect_to @copy, notice: 'Copie was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @copy.update(copy_params)
        format.html { redirect_to @copy, notice: 'Copie was successfully updated.' }
  ...
  def destroy
    @copy.destroy
    respond_to do |format|
      format.html { redirect_to copies_url, notice: 'Copie was successfully destroyed.' }
